#!/bin/bash
# ---------------------------------------------------------------------------
# tunnel-dev.sh  —  Method 2: SSM port-forward tunnel + local kubectl
#
...
#
# Usage:
#   bash scripts/tunnel-dev.sh          # starts tunnel, blocks until Ctrl-C
#
# In another terminal while tunnel is running:
#   KUBECONFIG=~/.kube/config-eks-dev-tunnel kubectl get nodes
#   KUBECONFIG=~/.kube/config-eks-dev-tunnel kubectl get pods -A
#
...
TUNNEL_KUBECONFIG="${HOME}/.kube/config-eks-dev-tunnel"
LOCAL_PORT=6443
